...
# The game consists of several rounds and in each round both 
# players obtain a score, based on how well they played. Once all
# the rounds have been played, the total score of each player is 
# determined by adding up the scores in all the rounds and the player 
...
# over the player who had the maximum lead at the end of any round in the
...
# 4	112	106
# 5	88	90
# The total scores of both players, the leader and
# the lead after each round for this game is given below:
...
# maximum lead (58 at the end of round 1) during the game.
